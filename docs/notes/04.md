...
I would like you to start convolutions with the filter "centered" on the top-left pixel of the image. The center of an odd size filter is the center pixel while the center of an even size filter is
